...
namespace Pokedex.Tests
{
    public class PokemonControllerTest
    {
        ...
        public async Task Get_Pokemon_OK()
        {
            ...
            _appProcessor.Setup(x => x.Process(It.IsAny<GetPokemonSpeicesRequest>())).Returns(Task.FromResult(new DefaultResponse<PokemonInfo>()
            {
        ...
        [Fact]
        public async Task Get_Pokemon_Translated_NotFound()
        {
            // Arrange
            var name = "steelix";
